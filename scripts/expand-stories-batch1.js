/* Batch 5a: Replace short A1 stories with expanded versions (~1,400 chars each)
   and add first 10 B2 stories. */
const fs = require('fs');
const path = require('path');
const FILE = path.join(__dirname, '..', 'public', 'data', 'stories.json');

const expanded = [
  // ── Expanded A1 stories ──────────────────────────────────────────────────
  {
    id: 'S001', num: 1, title: 'Mein Morgen', titleEn: 'My Morning', level: 'A1',
    de: `Ich heiße Lena und ich wohne in Hamburg. Jeden Morgen stehe ich um sieben Uhr auf. Mein Wecker klingelt laut. Ich gehe zuerst ins Badezimmer. Dort wasche ich mein Gesicht mit kaltem Wasser. Das hilft mir, wach zu werden. Dann putze ich meine Zähne. Das dauert zwei Minuten.
...
At the weekend we always eat together. My mother cooks very well. On Sundays we often make trips to the mountains or to the lake. That is my favourite time. I love my family very much. They give me strength and joy every day.`,
  ...
  },
  {
    ...
    de: `Heute gehe ich einkaufen. Ich brauche viele Dinge für die Woche. Zuerst schreibe ich eine Einkaufsliste. Ich brauche Brot, Milch, Käse, Eier, Äpfel, Tomaten, Nudeln und Joghurt. Meine Einkaufsliste ist lang.
...
At the checkout I wait briefly. A woman in front of me is buying a lot. Then it is my turn. The cashier is friendly and smiles. I pay nineteen euros fifty. I pay by card. Then I pack everything in my bag and go home. The shopping is done.`,
  ...
  },
  {
    ...
    de: `Ich habe einen Hund. Er heißt Bello und ist vier Jahre alt. Bello ist ein Labrador. Er hat goldenes Fell und große braune Augen. Er ist sehr schön und sehr freundlich. Alle Leute mögen Bello.
...
At the weekend we sometimes drive to the forest. Bello loves nature. He sniffs at flowers and trees. He jumps in puddles and then gets completely wet. At home I then have to wash him. He does not like that much. But I love my dog very much. He is my best friend.`,
  ...
  {
    id: 'S005', num: 5, title: 'Im Restaurant', titleEn: 'At the Restaurant', level: 'A1',
    de: `Heute gehe ich mit meiner Freundin Sarah in ein Restaurant. Das Restaurant heißt "Zur Sonne" und liegt in der Altstadt. Es ist ein gemütliches Restaurant mit roten Stühlen und kleinen Tischen. An den Wänden hängen schöne Bilder.
...
Die Entscheidung fiel ihr nicht leicht. Ein Masterstudium in Psychologie würde drei Jahre dauern. Sie würde weniger verdienen und vieles aufgeben müssen, was sie gewohnt war. Aber der Gedanke, täglich etwas Bedeutsames zu tun, überwog.
...
The decision was not easy for her. A master's degree in psychology would take three years. She would earn less and have to give up much of what she was used to. But the thought of doing something meaningful every day outweighed everything.
...
Today, two years after starting her studies, Miriam works as a student assistant in a counselling centre for young people with burnout. She earns significantly less than before. But when she comes home in the evening, she does not feel empty but fulfilled. Some decisions cost a lot — and are precisely the right ones for that reason.`,
  ...
  },
  {
    ...
    de: `Amara wurde in Accra geboren und kam mit sieben Jahren nach Deutschland. Ihre Eltern hatten sich bewusst für Köln entschieden — eine offene Stadt mit einer bunten, internationalen Bevölkerung. Trotzdem erlebte Amara in der Schule Momente, in denen sie merkte, dass sie zwischen zwei Welten stand.

Zu Hause sprachen sie Twi und kochten ghanaische Gerichte. Fufu mit Erdnusssuppe am Sonntag war heilig. Ihre Mutter trug bunte Stoffe, die in der Nachbarschaft manchmal Blicke erzeugten. In der Schule dagegen wollte Amara einfach dazugehören. Sie lernte schnell Deutsch, begeisterte sich für deutsche Literatur und sang im Schulchor.

Das Schwierigste war, wenn beide Welten kollidierten. Bei einer Schulfeier brachte Amara Kelewele — frittierte Kochbananen mit Ingwer und Chilipfeffer. Ihre Klassenkameradinnen probierten es zögerlich. Einige sagten höflich, es sei "interessant". Amara lachte, aber innerlich fragte sie sich, ob sie sich schämen sollte.

Mit achtzehn begann sie, Romanistik und Afrikanistik zu studieren. Im Studium lernte sie Konzepte wie Hybrididentität und kulturelle Zugehörigkeit kennen. Sie erkannte, dass ihre Zerrissenheit keine Schwäche war, sondern eine besondere Perspektive. Sie konnte zwischen Sprachen und Bedeutungswelten vermitteln, die anderen verschlossen blieben.

Heute arbeitet Amara als Übersetzerin und Kulturvermittlerin. Sie hält Vorträge an Schulen über Vielfalt und Zugehörigkeit. Wenn Kinder sie fragen, woher sie kommt, antwortet sie: "Ich komme von überall — und das ist mein größtes Geschenk."`,
    en: `Amara was born in Accra and came to Germany at the age of seven. Her parents had consciously chosen Cologne — an open city with a colourful, international population. Nevertheless, Amara experienced moments at school when she noticed that she stood between two worlds.

At home they spoke Twi and cooked Ghanaian dishes. Fufu with peanut soup on Sundays was sacred. Her mother wore colourful fabrics that sometimes drew glances in the neighbourhood. At school, by contrast, Amara simply wanted to belong. She learned German quickly, became enthusiastic about German literature and sang in the school choir.

The most difficult thing was when both worlds collided. At a school celebration Amara brought Kelewele — fried plantains with ginger and chilli pepper. Her classmates tried it hesitantly. Some politely said it was "interesting". Amara laughed but inwardly wondered whether she should be ashamed.

At eighteen she began studying Romance languages and African studies. During her studies she became acquainted with concepts such as hybrid identity and cultural belonging. She recognised that her sense of being torn was not a weakness but a special perspective. She could mediate between languages and worlds of meaning that remained closed to others.

Today Amara works as a translator and cultural mediator. She gives talks at schools about diversity and belonging. When children ask her where she comes from, she answers: "I come from everywhere — and that is my greatest gift."`,
  ...
  },
  {
    ...
    de: `Felix hatte sich auf siebenundvierzig Stellen beworben. Siebenundvierzig Mal hatte er sein Motivationsschreiben angepasst, seinen Lebenslauf optimiert und auf eine Antwort gewartet. Bei vierzig Bewerbungen kam gar keine Rückmeldung. Sechs führten zu Absagen. Nur eine einzige hatte zu einem Vorstellungsgespräch geführt — und der Termin war heute.

Die Stelle war bei einem mittelgroßen IT-Unternehmen in Berlin. Felix hatte das Unternehmen gründlich recherchiert. Er kannte ihre Produkte, ihre Marktposition und sogar den Namen der Personalchefin, die ihn eingeladen hatte. Er hatte sich passend gekleidet: ein hellblaues Hemd, eine dunkle Hose, saubere Schuhe. Nicht zu formal, nicht zu lässig.

Das Gespräch begann gut. Die Personalchefin, Frau Brandt, war direkter und freundlicher, als er erwartet hatte. Sie fragte nach seinem technischen Hintergrund, nach Projekten, an denen er gearbeitet hatte, und nach seiner Erfahrung im Teamwork. Felix antwortete ruhig und strukturiert, auch wenn sein Herz schnell schlug.
...
Am Ende des Gesprächs durfte Felix selbst Fragen stellen. Er fragte nach dem Team, den Entwicklungsmöglichkeiten und der Unternehmenskultur. Drei Tage später erhielt er eine E-Mail: Er war eingestellt. Felix las die E-Mail dreimal, bevor er glaubte, was er sah.`,
    en: `Felix had applied for forty-seven positions. Forty-seven times he had adapted his cover letter, optimised his CV and waited for a reply. For forty applications no response came at all. Six led to rejections. Only one had led to a job interview — and the appointment was today.

The position was at a medium-sized IT company in Berlin. Felix had researched the company thoroughly. He knew their products, their market position and even the name of the HR manager who had invited him. He had dressed appropriately: a light blue shirt, dark trousers, clean shoes. Not too formal, not too casual.

The conversation started well. The HR manager, Ms Brandt, was more direct and friendly than he had expected. She asked about his technical background, projects he had worked on, and his experience of teamwork. Felix answered calmly and in a structured way, even though his heart was beating fast.
...
At the end of the interview Felix was allowed to ask questions himself. He asked about the team, development opportunities and the company culture. Three days later he received an email: he had been hired. Felix read the email three times before he believed what he saw.`,
...
// Replace or add each story by id
const map = new Map(data.map(s => [s.id, s]));
expanded.forEach(s => map.set(s.id, s));
const out = [...map.values()];

fs.writeFileSync(FILE, JSON.stringify(out));
const b2count = out.filter(s => s.level === 'B2').length;
const avgA1 = Math.round(out.filter(s=>s.level==='A1').reduce((s,x)=>s+x.de.length,0)/out.filter(s=>s.level==='A1').length);
console.log(`Done. Total stories: ${out.length}. B2 stories: ${b2count}. Avg A1 chars: ${avgA1}.`);
expanded.forEach(s => console.log(`  [${s.level}] ${s.title}: ${s.de.length} chars`));
